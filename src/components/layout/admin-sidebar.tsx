...
export function AdminSidebar({
  ...
  return (
    <>
      {/* Overlay para fechar ao clicar fora em telas pequenas */}
      {open && (
        <div
      ...
      <aside
        className={cn(
          "glass fixed inset-y-0 left-0 z-50 flex w-60 flex-col border-r border-sidebar-border transition-transform duration-200",
