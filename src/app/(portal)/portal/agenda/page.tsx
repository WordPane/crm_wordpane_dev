...
} from "@/lib/queries/portal-calendar";
...
export default async function PortalAgendaPage({
  ...
  let projects;
  try {
    [events, summary, projects] = await Promise.all([
      getPortalCalendarEvents(user, {
  ...
  const cards = [
    { label: "Vencidos", value: summary.vencidos, alert: summary.vencidos > 0 },
